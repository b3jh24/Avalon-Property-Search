...
filePath = "C:/Users/BHornak/Desktop/ownerInfo.txt"
numberOfProps = 1
...
def submitForm():
    ...
    for k in xrange(0,len(propertyList)):
        br = Browser()
        ...
        try:
            ...
            master.quit()
            tkMessageBox.showerror("ERROR","Property could not be found\nCheck that you entered the full street name?")
            return
        ...
        with open(filePath,"a") as ownerFile:
            ...
            ownerFile.write("\nAvalon residence: "+ propertyList[k])
            ownerFile.write("\n\n")
